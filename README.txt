...
1. Put your FASTQ files to FASTQ directory
2. Start the script using "qsub run.qsub" command
3. Wait around 10 minutes and visit waxmanlabvm.bu.edu/NanoporeResults/ directory
